...
>
	<span class="text-lg font-medium text-primary-solid">404</span>
	...
	<a
		href="/"
		class="mx-auto mt-6 flex w-fit items-center justify-center gap-1 p-2 text-sm font-semibold text-primary-solid transition-opacity hover:opacity-70"
	>
